...
; For example configVariableNameArray[1] = "URL_FILE_LOCATION"
; and configFileContentArray[1] = "A_ScriptDir . "\files\YT_URLS.txt""
...
; For example (1) to return URL_FILE_LOCATION's content
